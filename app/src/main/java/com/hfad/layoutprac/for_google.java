...
public class for_google extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_for_google);
        ...
        googleApiClient = new GoogleApiClient.Builder(for_google.this)
                .enableAutoManage(for_google.this , new GoogleApiClient.OnConnectionFailedListener() {
                    @Override
    ...
    public void FirebaseUserAuth(GoogleSignInAccount googleSignInAccount) {
        ...
        Toast.makeText(for_google.this,""+ authCredential.getProvider(),Toast.LENGTH_LONG).show();

        firebaseAuth.signInWithCredential(authCredential)
                .addOnCompleteListener(for_google.this, new OnCompleteListener() {
                    @Override
                    public void onComplete(@NonNull Task AuthResultTask) {
                        ...
                        if (AuthResultTask.isSuccessful()){
                         ...
                         //   LoginUserName.setText("NAME =  "+ firebaseUser.getDisplayName().toString());
                            ...
                            edit.putString("user",firebaseUser.getDisplayName().toString());
                            edit.putString("userType","profile");
                            edit.commit();
//Setting up Email into TextView.
//LoginUserEmail.setText("Email =  "+ firebaseUser.getEmail().toString());
                            edit.putString("email",firebaseUser.getEmail().toString());
                            Log.d("#000","data is in shared preference");
                            edit.commit();
                            Intent i=new Intent(for_google.this,MainActivity.class);
                            startActivity(i);
                        }else {
                            Toast.makeText(for_google.this,"Something Went Wrong",Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
        ...
        Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(
                new ResultCallback() {
                    ...
                    public void onResult(@NonNull Result result) {
                        ...
                        Toast.makeText(for_google.this, "Logout Successfully", Toast.LENGTH_LONG).show();
