...
public class for_mobile extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_for_mobile);
...
//                    Log.d("Error", "The SMS quota for the project has been exceeded");
                    Toast.makeText(for_mobile.this, getString(R.string.sms_qutoa_exceeded_alert), Toast.LENGTH_SHORT).show();
...
//                    llOTPNumberLayout.setVisibility(View.VISIBLE);
            ...
            public void onCodeAutoRetrievalTimeOut(String s) {
                ...
                if (TextUtils.isEmpty(code)) {
                    Toast.makeText(for_mobile.this, getString(R.string.otp_blank_alert), Toast.LENGTH_SHORT).show();
                } else {
...
//                Log.d(TAG, "onCodeSent:" + verificationId);
                ...
                startTimer();
                Toast.makeText(for_mobile.this, getString(R.string.otp_send_message), Toast.LENGTH_SHORT).show();
                llPhNumberLayout.setVisibility(View.GONE);
                llOTPNumberLayout.setVisibility(View.VISIBLE);
                // ...
            }
...
//                            Log.d(TAG, "signInWithCredential:success");
                            ...
                            Log.d("#000", "onComplete: user is " + user.toString());
...
//                            Toast.makeText(MainActivity.this, "Ph number verified", Toast.LENGTH_SHORT).show();
                            ...
                            stopTimer();
                            Intent i=new Intent(for_mobile.this,MainActivity.class);
                            startActivity(i);
                            // ...
                        } else {
...
//                            Log.w(TAG, "signInWithCredential:failure", task.getException());
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(for_mobile.this, getString(R.string.wrong_verification_code_alert), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
